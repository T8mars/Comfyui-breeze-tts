"""Vendored from breezeblue-ai/breeze-tts (models/t5gemma2_compat.py), Apache-2.0.

Used as the T5Gemma2 text encoder fallback on transformers versions that do
not ship a native T5Gemma2 implementation (<5.x). On transformers >=5 the
native T5Gemma2TextEncoder is used instead (see native.py).
"""
